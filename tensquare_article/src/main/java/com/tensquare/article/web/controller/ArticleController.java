...
public class ArticleController {
    ...
    public ResultDTO examine(@PathVariable String articleId) {
        this.articleService.updateArticleStateToExamine(articleId);
        return new ResultDTO(true, StatusCode.OK, "修改成功");
    }
    ...
    public ResultDTO thumbup(@PathVariable String articleId) {
        this.articleService.updateArticleThumbupToIncrementing(articleId);
