...
public class RecruitController {
    ...
    public ResultDTO listRecommend() {
        return new ResultDTO(true, StatusCode.OK, "查询成功", this.recruitService.findRecruitListNewTop4ByState("2"));
    }
    ...
    public ResultDTO listNew() {
        return new ResultDTO(true, StatusCode.OK, "查询成功", this.recruitService.findRecruitListNewTop12());
    }
}
